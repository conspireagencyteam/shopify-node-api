...
export declare const Shopify: {
    ...
    Auth: {
        ...
        beginAuth(request: import("http").IncomingMessage, response: import("http").ServerResponse, shop: string, redirectPath: string, isOnline: boolean | undefined, app: string): Promise<string>;
