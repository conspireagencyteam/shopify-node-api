...
declare const ShopifyOAuth: {
     ...
     */
    beginAuth(request: http.IncomingMessage, response: http.ServerResponse, shop: string, redirectPath: string, isOnline: boolean | undefined, app: string): Promise<string>;
    /**
